...
const selected = catalogueService.selectedCodes(args, catalogue, false);
const results = selected.map(code => catalogueService.fetchApp(catalogue.apps[code], code, dryRun));
